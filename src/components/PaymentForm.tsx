...
const PaymentForm = ({ packageDetails, userEmail }: PaymentFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call Square payment processing function
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-amber-200/70 text-sm mt-2 text-serif">
          Complete your information below to proceed with secure payment
        </p>
      </div>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                Pay ${packageDetails.price} - {packageDetails.name}
              </>
            )}
          </Button>
        </div>
