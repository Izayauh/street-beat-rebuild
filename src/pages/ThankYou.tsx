...
const ThankYou = () => {
  useEffect(() => {
    // Log the successful payment completion
    console.log('Payment completed successfully via Square');
  }, []);
          ...
          <div className="max-w-2xl mx-auto">
            <div className="card-analog p-12 rounded-2xl warm-glow">
              ...
              <p className="text-xl text-amber-200/80 mb-8 text-serif leading-relaxed">
                Your payment has been processed successfully through Square. 
              ...
              <div className="space-y-4 text-amber-200/70 text-serif">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span>A confirmation email will be sent to your inbox</span>
                </div>
                <div className="flex items-center justify-center gap-2">
